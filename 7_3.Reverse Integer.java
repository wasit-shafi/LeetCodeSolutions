...
// My previous 2 solution is actually incorrect for this specific question as is mentioned we are dealing with 32-bit environment, so how can i use long (64-bit number)...:)
